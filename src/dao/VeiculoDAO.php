...
class VeiculoDAO {
    ...
    public function listar($empresa = NULL) {
        ...
        try{
            ...
            $data = $query->fetchAll(\PDO::FETCH_CLASS|\PDO::FETCH_PROPS_LATE, \Model\Veiculo::class);
    ...
    public function buscar($id) {
        try {
            ...
            $query->setFetchMode(\PDO::FETCH_CLASS|\PDO::FETCH_PROPS_LATE, \Model\Veiculo::class);
            $query->execute();
